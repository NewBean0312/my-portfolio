...
- [포트폴리오 v2.0](https://github.com/NewBean0312/portfolio/commit/5dd6c22e9979f50503e5e37a6245e00abfbeef8a)
  - 업데이트 날짜 : 2023.11.17
  - 전체 색상 변경
  - 메인 페이지 건반 애니메이션 추가
  - 마우스 커서 삭제
...
- [포트폴리오 v2.1](https://github.com/NewBean0312/portfolio/commit/4218389ef7de1a4541e013c8c4eb0b0ec141a149)
  - 업데이트 날짜 : 2024.02.28
  - Main 페이지 반응형 버전 링크 오류 수정
  - Project 페이지 프로젝트 추가
  - 브라우저 스크롤 오류 수정
- [포트폴리오 v2.2]()
  - 업데이트 날짜 : 2024.03.19
  - Main 페이지 건반 소리 추가
  - Skills 페이지 로고 클릭 시, 상세 페이지 추가
